...
import { Image, Send, Upload, Zap, MessageCircle, AlertTriangle, AtSign } from 'lucide-react';
        ...
        <CardContent className="p-4">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="font-bold text-black">{profile?.name || note.pubkey.substring(0, 8)}</div>
